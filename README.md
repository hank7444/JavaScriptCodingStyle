...
2013.08.08 | 1.1  | * 1.7.5 新增物件屬性風格說明<br/> * 1.7.6 新增陣列元素風格說明<br/> * 增加4.3函式參數風格說明<br/> | Hank Kuo|
2013.07.11 | 1.0  | * 1.3改為'建議' <br/> * 增加1.6.3 全域變數說明 <br/> * 1.7.2增加perseInt()使用規則說明<br/> * 1.7.3增加簡易檢測變數與參數說明<br/>* 修改2.1多行注解規則<br/> * 修改3.4 assign變數風格(=前後需空一格) <br/> * 修改4.1變數宣告風格(每個變數都要有var) <br/> * 新增4.1.1變數宣告位置說明<br/> * 4.2函式宣告新增匿名函式說明  | Hank Kuo |
2013.07.03 | 1.0 beta2  |文件改用markdown撰寫, 增加變數, 函式, 運算符, 錯誤處理, 類型檢測等風格 | Hank Kuo |
2012.12.06 | 1.0 beta1 |建立文件, 基本程式風格建立 | Mars Peng |
